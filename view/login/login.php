                ...
                <div class="card" style="background-color: rgba(255, 255, 255, 0); border: none;">
                    <div class="card-body ">
                        <div class="text-center">
                            ...
                            <h1 class="text-light shadow-lg" style="font-family: 'Chakra Petch', sans-serif;">Komukasi Global</h1>
                        </div>
                        <form>
                            <div class="form-group">
                                <label for="username" class="fw-bold text-light">Username</label>
                                <input type="text" class="form-control" id="username" placeholder="Enter username" style="background-color: #f0f8ff;">
                            </div>
                            <div class="form-group">
                                <label for="password" class="fw-bold text-light">Password</label>
                                <input type="password" class="form-control" id="password" placeholder="Enter password" style="background-color: #f0f8ff;">
                            </div>
                            <div class="form-group">
