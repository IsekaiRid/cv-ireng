...
<body style="background-image:url('https://i.pinimg.com/originals/a6/e2/3b/a6e23bc8c9c862538a7f31dc2f651d98.gif'); background-size: cover; background-repeat: no-repeat;background-position: center;">
                ...
                <div class="card" style="background-color: rgba(255, 255, 255, 0); border: none;">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <h1 class="text-light shadow-lg" style="font-family: 'Chakra Petch', sans-serif;">Komunikasi Global</h1>
                        </div>
                        <form method="POST" action="/prosesLogin">
                            <div class="form-group">
                                <label for="username" class="fw-bold text-light">Username</label>
                                <input type="text" class="form-control" id="username" placeholder="Enter username" style="background-color: #f0f8ff;" name="name">
                            </div>
                            <div class="form-group">
                                <label for="password" class="fw-bold text-light">Password</label>
                                <input type="password" class="form-control" id="password" placeholder="Enter password" style="background-color: #f0f8ff;" name="password">
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn btn-danger btn-block w-100">Join</button>
                                <a href="/register" class="btn btn-info btn-block w-100 mt-1">Register</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <?php
    require_once("../view/login/layout/footer.php");
    ?>
</body>
